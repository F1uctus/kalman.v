(*
  ...
  Обращение $p crossproduct p$-матрицы для усиления Калмана остаётся параметром `cinv`
  с обязательством `cinv_correct`, как и в `riccati.v`; оно снимается
...
Section BridgeC.
  ...
  (*
    ...
    где $K_f$ обозначает усиление Калмана на предсказанной ковариации;
    эта матрица исследуется в `dare.v`.
  *)
