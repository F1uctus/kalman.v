...
Section Spectral.
  ...
  *)
  ...
  (*
    Обращение в ноль квадратичной формы неотрицательно определённой $M$ влечёт
    обращение в ноль столбца: $v† M v = 0 => M v = 0$.
  *)
  Lemma psd_qf0_mul0 n (M : 'M[ℂ]_n) (v : 'cV[ℂ]_n) :
    psd M -> \tr (v^t* *m M *m v) = 0 -> M *m v = 0.
  (*
    Через спектральную теорему
    $M = U "diag"(l) U†, l_i >= 0 : v† M v = Σ_i l_i |(U† v)_i|^2$; обращение в
