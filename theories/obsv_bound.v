(*
  ...
  $"invmx" P$ и $"invmx" Q$. Затравочная оценка при $K = 0$ выше даёт
  ослабленную (зависящую от $F$) оценку, достаточную для построения предельного
  $P_ss$ при дополнительной гипотезе устойчивости.
