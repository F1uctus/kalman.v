...
Section DARE.
  ...
  *)
  ...
  (*
    ...
    суммы Ляпунова замкнутого контура, а та равномерно мажорируется `Pbnd`.
  *)
  ...
  (*
    ...
    Предел траектории из нуля $P_(s s)$ существует в матричной топологии.
  ...
  *)
  ...
  (*
    Тождество Ляпунова замкнутого контура для предсказанной стационарной
    ковариации.
  ...
  *)
  ...
  (*
    ...
    неотрицательно определённого начала сходится к $P_(s s)$ в матричной
    топологии. Это стандартный результат теории ДАУР, требующий устойчивости
    замкнутого контура; у нас он доказан (теорема ниже) зажатием траектории
    между нижней и верхней (суперрешение) траекториями при спектральной
  ...
  *)
  ...
  (*
    ...
    $P_(s s)$. Начало мажорируется суперрешением уравнения Риккати с масштабом
    $a := "tr" P_0$, после чего траектория из $P_0$ зажимается между траекторией
    из нуля и траекторией из суперрешения; обе сходятся к $P_(s s)$.
  ...
  *)
  ...
  (*
    ...
    $F_p P_(p s s) F_p† prec.eq P_(p s s)$: по тождеству замкнутого контура
    разность равна $K_p R K_p† + G Q G†$ и неотрицательно определена.
  *)
  Theorem Fp_Ppss_le :
  ...
  (*
    ...
    $P_(p s s)$ есть положительно определённая неподвижная точка предсказанной
  ...
  *)
  ...
  (*
    ...
    отклонение ковариации $P_k - P_(s s)$ от установившейся распространяется
  ...
  *)
  ...
  (*
    ...
    $P_(s s)$, а усиление Калмана к стационарному, по норме Фробениуса.
  *)
