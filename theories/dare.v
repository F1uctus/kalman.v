...
Section DARE.
  ...
  *)
  ...
  (*
    ...
    `M1 − M2 = Fp(M1)(M1−M2)Fp(M2)†` с обоими устойчивыми по Шуру контурами
  ...
  *)
  ...
  (*
    ...
    весом `R⁻¹` равна бесконечной сумме `∑_k (Fp†)^k (H† R⁻¹ H) Fp^k`, т.е.
    бесконечным грамианом наблюдаемости замкнутого контура под весом `H† R⁻¹ H`.
