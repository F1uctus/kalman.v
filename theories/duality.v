(*
  ...
  двойственный по управлению заменой $(F, G) |-> (F†, G†)$. Для левого и правого
  критериев PBH собственное значение при этом сопрягается, $λ |-> λ^*$, а его
  ...
  - `stabilizable_dual` - стабилизируемость пары $(F, G)$ равносильна
    ...
    (левый критерий PBH переходит в правый);
