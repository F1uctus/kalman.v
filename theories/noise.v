(*
  ...
  минус α и плюс минус β на шестнадцати равновероятных исходах 'I_16 (значениям
  α и минус α отвечают по пять исходов, значениям β и минус β по три). Среднее
  равно нулю, второй момент равен $(5 α² + 3 β²) / 8$; подбором α и β второй
  момент совпадает с заданной скалярной ковариацией шума.
