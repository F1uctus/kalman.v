...
Section SpecRad.
  ...
  *)
  ...
  (*
    ...
    диска. Нужна для определения обнаруживаемости
    ([kailath2000], App. C, § C.4): пара (F, H) с замыкающим K, делающим F − KH
    устойчивой по Шуру, не имеет ненаблюдаемых неустойчивых мод.
...
(*
  ==============================================================================
  Сходимость степеней при сжатии по норме Фробениуса
  ==============================================================================
  ...
  через теорему о двух милиционерах и переход к норме Фробениуса
  (`frob_sq_cvgn0_to_mxcvgn`). Архимедовость - явная гипотеза
