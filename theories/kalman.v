...
Section KalmanFilter.
  ...
  *)
  ...
  (*
    ...
    матрицы усиления Калмана доказаны в `dare.v` ([kailath2000], § 14.5).
    Примерное доказательство: детектируемость `[F,H]` => стабилизирующее
    усиление => устойчивость по Шуру матрицы замкнутого контура.
