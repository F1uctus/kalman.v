...
Section LyapunovPartialSum.
  ...
  *)
  ...
  (*
    Тождество сдвига:
    $"lyap_partial" (N+1) = Q + A dot "lyap_partial" N dot A†$. Доказывается
    индукцией по $N$.
  *)
  ...
  (*
    ...
    $"lyap_partial" N prec.eq P$. Чисто алгебраически
    (конечная частичная сумма), без устойчивости: разность
