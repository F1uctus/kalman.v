(*
  ...
  Строгость следует из PBH-детектируемости: при `|lam| = 1` правая часть
...
Section LyapInv.
  ...
  *)
  ...
  (*
    Дискретный критерий Ляпунова (замкнуто-контурная форма): положительно
  ...
  *)
  ...
  (*
    Замкнуто-контурная форма (левый собственный вектор), положительно
    определённый вес.
  *)
