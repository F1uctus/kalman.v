...
ковариации $R_(e,k)$, её обращение и оптимальность усиления Калмана все
опираются на то, что $P_(k+1|k)$ остаётся корректной ковариационной матрицей
(эрмитовой и неотрицательно определённой). Эти два свойства являются
_инвариантом цикла_ предсказание–обновление и доказываются по индукции.
...
Определение усиления Калмана $K_k = P_(k|k-1) H^* R_(e,k)^(-1)$ содержит
_обращение_ инновационной ковариации $R_(e,k)$. Если $R_(e,k)$ необратима, то
усиление не определено как математический объект, и говорить о следующем шаге
фильтра бессмысленно. Положительная определённость $R$, принятая в @intro,
оказывается достаточным условием: она передаётся инновационной ковариации через
сложение неотрицательно определённых матриц.
...
$K_k = P_(k|k-1) H^* R_(e,k)^(-1)$, минимизирует апостериорную ковариацию ошибки
в смысле порядка Лёвнера (и потому минимизирует её след). Доказательство
опирается на тождество _выделения полного квадрата_ для матриц.
