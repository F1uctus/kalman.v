...
#set text(size: 14pt)
Прогон извлечённого фильтра: все данные, включая шумы (четырёхточечная
модель, генератор Лемера внутри Rocq), построены извлечённой программой;
вхождение ошибки в коридор $plus.minus 2 sigma_k$ доказано леммой
`sim_run_in_band`.
