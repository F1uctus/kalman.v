...
При шумах с нулевым средним и $EE err(x)_0 = 0$ среднее ошибки
остаётся нулевым на каждом шаге, причём при произвольном усилении
наблюдателя:
...
#two-col(
  ...
  [
    - `kalman_gain_optimal`: усиление Калмана
      ...
      доказательство ведётся выделением
      полного квадрата
    - `kalman_gain_normal_eq`: стационарное
      условие
      $
