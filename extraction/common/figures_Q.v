(*
  ...
  CertiRocq программа. Оба целевых каталога, `extraction/c` и
  `extraction/wasm`, берут отсюда одни и те же термы и содержат только команды
  компиляции, поэтому печать документа определена в проекте единственный раз.
